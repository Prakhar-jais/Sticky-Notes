  ...
  ticketDiv.innerHTML = `<div class="ticket-header ${ticketFilter}"></div>
    <div class="ticket-content">
        <div class="ticket-info">
            ...
            <div class="ticket-lock fas fa-lock"></div>
    ...
    let lock_btn = ticketDiv.querySelector(".ticket-lock");
    lock_btn.addEventListener("click",function(e){
        lockTicket = true ;
        
        ticketDiv.querySelector(".ticket-lock").classList.add("locked");
        
    })
    lock_btn.addEventListener("dblclick",function(e){
        lockTicket = false ;
        ticketDiv.querySelector(".ticket-lock").classList.remove("locked");
    })
